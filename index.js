// State Management
        ...
        function nextScreen() {
            ...
            if (currentScreenIndex === 3) {
                ...
                nextScreenNumber = 8; // Go to Home Page
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
         ...
         // --- Kode untuk tombol Plus ---
        const plusButton = document.getElementById('plus-button');
        const plusMenu = document.getElementById('plus-menu');

        if (plusButton && plusMenu) {
            plusButton.addEventListener('click', function(event) {
                // Mencegah event 'click' menyebar ke elemen window
                event.stopPropagation();
                // Toggle class 'hidden' pada menu
                plusMenu.classList.toggle('hidden');
            });

        // Menyembunyikan menu jika diklik di mana saja di luar menu
